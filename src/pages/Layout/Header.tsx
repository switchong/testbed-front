    ...
    return (
            <div className={headerCSS.firstHeader}>
                ...
                <div className={headerCSS.middleButton}>
                    {
                        state === null ?
                        <>  <Button style={{backgroundColor: "white"}} variant="light" className={`${headerCSS.accountheader} ${headerCSS.text}`} active>전체 계좌</Button>
                            <Button style={{ backgroundColor: "white"}} variant="light" className={`${headerCSS.accountheader} ${headerCSS.rightOver} ${headerCSS.text}`} active>다른 금융</Button>
                        </> :
